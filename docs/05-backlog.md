...
| # | Việc | Ghi chú |
|---|---|---|
| 9 | **[NGƯỜI] Hỏi HQ: có được nêu ESPRESSO / số 160 TOPS đối ngoại không?** Nếu không, gỡ khối `#espresso` ở `/products` và mốc 9/2026 ở *Lịch sử hình thành*. **Thêm 21/08/2026:** `06-strategy-review.md` §4.2 đọc deck v4 s17 thấy ESPRESSO family launch nằm ở **2027**, mâu thuẫn với `01-proof-bank.md` §E3 ("Available from Sep. 2026", IR Deck 05/01/2026). GM đã chốt **giữ 9/2026** khi điền content VI. Câu hỏi cho HQ giờ là hai vế: *được nói không* **và** *ngày nào đúng*. Có đồng hồ: **01/10/2026** mốc này thành lời hứa vỡ trên chính trang lấy "gắn nhãn trung thực" làm điểm khác biệt | ⚠ ưu tiên cao nhất |
